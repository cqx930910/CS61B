...
public class MapServer {
    ...
    public static List<String> getLocationsByPrefix(String prefix) {
        String cleanedPrefix = graph.cleanString(prefix);
        List<String> toreturn = new ArrayList<>();
        for (String i: graph.locationTrie.keysWithPrefix(cleanedPrefix)){
            toreturn.add(graph.locationTrie.get(i).name);
        }
        return toreturn;
    }
    ...
    public static List<Map<String, Object>> getLocations(String locationName) {
        ...
        for (String i: graph.locationTrie.keysThatMatch(cleanedName)){
            HashMap<String,Object> info = new HashMap<>();
            Location i_location = graph.locationTrie.get(i);
            info.put("lat",i_location.lat);
            info.put("lon",i_location.lon);
            info.put("name",i_location.name);
            info.put("id",i_location.id);
            toreturn.add(info);
        }
        return toreturn;
    }
