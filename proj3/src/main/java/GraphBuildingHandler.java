...
//            System.out.println("Node lat: " + attributes.getValue("lat"));
            ...
            GraphNode newNode = new GraphNode(attributes.getValue("id"), attributes.getValue("lon"),
...
//            System.out.println("Beginning a way...");
            newEdge = new GraphEdge(attributes.getValue("id"));
        } else if (activeState.equals("way") && qName.equals("nd")) {
            /* While looking at a way, we found a <nd...> tag. */
//            System.out.println("Id of a node in this way: " + attributes.getValue("ref"));
            newEdge.addNode(attributes.getValue("ref"));
...
//                System.out.println("Max Speed: " + v);
                newEdge.maxspeed = Integer.parseInt(v.substring(0, v.indexOf(" ")));
                ...
                edgeFlag =(ALLOWED_HIGHWAY_TYPES.contains(v));
...
//            System.out.println("Node's name: " + attributes.getValue("v"));
            ...
            Location newLocation = new Location(lastNode.id,lastNode.lon,lastNode.lat,lastNode.name);
            g.locationTrie.put(g.cleanString(newLocation.name),newLocation);
        }
    }
